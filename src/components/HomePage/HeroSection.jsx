...
export default function HeroSection() {
  return (
    <section className='text-center px-[23px]'>
      <div className='bg-hero_background h-[600px] -top-[320px] left-0 absolute w-[50%] z-10 opacity-[0.4] lg:hidden'></div>
      <div className='bg-hero_background h-[600px] -top-[320px] right-0 absolute w-[40%] z-10 opacity-[0.4] lg:hidden'></div>
      <div className='flex flex-col gap-5 items-center pt-156px max-w-[910px] mx-auto'>
        <h1 className='w-200px text-4xl leading-normal font-medium text-primary_dark lg:text-7xl lg:w-full'>
          Get{' '}
